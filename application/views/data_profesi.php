    ...
    <div class="container">
      <div class="row">
        <div class="col s10 m6 l6">
          <h5 class="breadcrumbs-title mt-0 mb-0"><span>Data Profesi</span></h5>
...
<a id="tambah" href="<?php echo base_url('master_data/tambah_profesi') ?>" class="btn btn-success">Tambah Data</a>
...
<script type="text/javascript" language="javascript" >
  $(document).ready(function() {
    var dataTable = $('#DataKuliner').DataTable( {
      ...
      "ajax":{
        url :"<?php echo site_url('Master_data/json_profesi/')?>",
        type: "POST",
        error: function(){
          $(".my-grid-error").html("");
