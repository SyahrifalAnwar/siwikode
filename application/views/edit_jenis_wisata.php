...
<form action="<?php echo base_url('master_data/simpan_editjenis_wisata/').$data['id'] ?>" method="POST" enctype="multipart/form-data">
    <div class="row">
        <div class="input-field col s12">
            <input type="text" required="" id="nama" value="<?php echo $data['nama'] ?>" name="nama" placeholder="">
            <label for="nama" class="active">Jenis Wisata</label>
        </div>
    </div>
<div class="row">
