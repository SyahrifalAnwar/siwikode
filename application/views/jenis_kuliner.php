 		...
 		<div class="container">
 			<div class="row">
 				<div class="col s10 m6 l6">
 					<h5 class="breadcrumbs-title mt-0 mb-0"><span>Jenis Kuliner</span></h5>
...
<a id="tambah" href="<?php echo base_url('master_data/tambah_jenis_kuliner') ?>" class="btn btn-success">Tambah Data</a>
 								...
 								<div class="row">
 									...
 									<div class="col s12">
 										<div id="data-table-simple_wrapper" class="dataTables_wrapper">
 											...
 											<table id="DataKuliner" class="display dataTable dtr-inline collapsed" role="grid" aria-describedby="data-table-simple_info" style="width: 100%;">
 												<thead>
 													<tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="data-table-simple" rowspan="1" colspan="1" style="width: 260px;" aria-sort="ascending" aria-label="Name: activate to sort column descending">NO</th>
 														<th class="sorting" tabindex="0" aria-controls="data-table-simple" rowspan="1" colspan="1" style="width: 391px;" aria-label="Position: activate to sort column ascending">Nama Kuliner </th>
 ...
 <script type="text/javascript" language="javascript" >
 	$(document).ready(function() {
 		var dataTable = $('#DataKuliner').DataTable( {
 			...
 			"ajax":{
 				url :"<?php echo site_url('Master_data/json_jenis_kuliner/')?>",
 				type: "POST",
 				error: function(){
 					$(".my-grid-error").html("");
