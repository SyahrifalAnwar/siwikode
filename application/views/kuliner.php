...
<body>
	...
	<main>
		...
		<section class="hero_in restaurants start_bg_zoom">
			<div class="wrapper">
				<div class="container">
					<h1 class="fadeInUp animated"><span></span>KULINER DEPOK</h1>
				</div>
			</div>
		</section>
		<!--/hero_in-->
							...
							<div class="col-lg-5">
								...
								<div class="col-lg-7">
									<div class="wrapper">
										...
										<h3><a href="<?= base_url('page/kuliner/').$get_data['id'] ?>"><?= $get_data['nama'] ?></a></h3>
										<p><?= substr($get_data['deskripsi'], 0, 300).' ...' ?></p>
									</div>
									<ul>
										<li><a href="<?= base_url('page/kuliner/').$get_data['id'] ?>" class="btn btn-primary"><i class="ti-eye"></i> Detail</a></li>
