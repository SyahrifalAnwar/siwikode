 <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>app-assets/css/pages/data-tables.min.css">
            ...
            <div class="card-content">
              <div class="row">
                ...
                <div class="col s12">
                  ...
                  <table id="data-table-simple" class="display dataTable dtr-inline collapsed" role="grid" aria-describedby="data-table-simple_info" style="width: 100%;">
                    <thead>
